...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  let apiUrl = `${process.env.SERVER_HOST_URL}/api/stone`;
...
export default function Stone(props:any) {
    return (
      <section className="steelwork-section">
        ...
        <div className="sub-title">주춧돌</div>
        <div className="info-area">
          {
            props.products.map((item:any, index:number)=>{
              ...
              <div className="item-image" style={{
                      backgroundImage: item.images.products[0]
                    }}></div>
                    <div className="item-image" style={{
                      backgroundImage: item.images.models[0]
                    }}></div>
              <div className="item-image" style={{
                      backgroundImage: item.images.products[0]
                    }}></div>
