...
export const getServerSideProps: GetServerSideProps = async (context) => {
	...
	let apiUrl = `${process.env.SERVER_HOST_URL}/api/admin/${queryData.pageType}`;
...
const ProductIndex:NextPage = (props:any) => {
	...
	let pageType:string = typeof router.query.pageType == "string" ? router.query.pageType : "";
	return <>
		<ProductComponent pageData={props} pageType={pageType}/>
	</>
}
